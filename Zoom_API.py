...
def loadConfig():
    ...
    sys.stdout.write("\n")
    sys.stdout.write("Carregando arquivo de configuração...")
    sys.stdout.write("\n")
    ...
    if os.path.isfile(CONFIG_FILE):
        ...
        sys.stdout.write("Arquivo de configuração carregado com sucesso.")
        sys.stdout.write("\n") 
        sys.stdout.write("\n")

    else:

        sys.stdout.write("Arquivo de configuração nao encontrado, carregando com valores padrões...")
        sys.stdout.write("\n")
        sys.stdout.write("\n")
        ...
        CONFIG_DATA = {
            ...
            "WEBEX_ACCESS_TOKEN": "",
            "WEBEX_ROOM_ID": "",
            "intervalScheduler_Time": 3600,
        }

# A function to store CONFIG_DATA to file
def saveConfig():

    sys.stdout.write("Salvando arquivo de configuração...")
    sys.stdout.write("\n")
...
def intervalScheduler(function, interval):
    ...
    # handle keyboard interrupt
        ...
        sys.stdout.write("\n")
        sys.stdout.write("\n")
        sys.stdout.write("Exiting... Zoom Web Service Parser não vai ser mais atualizado automaticamente.\n")
        sys.stdout.write("\n")
        sys.stdout.flush()
        pass
...
def check_for_new_version():
    ...
    if not path.exists("json"):
        # criar pasta json caso deletada ou primeira vez rodando script, criando...
        sys.stdout.write("Pasta Json nao existe, criando...")
        os.mkdir("json")
...
if __name__ == "__main__":
    ...
    try:
        if CONFIG_DATA['SERVICE']:
            ...
            intervalScheduler(WebServiceParser, CONFIG_DATA['intervalScheduler_Time'])
        else:
            # Execute  just once
            WebServiceParser()
